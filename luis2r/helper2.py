...
def gen_test_output(sess, logits, keep_prob, image_pl, data_folder, image_shape):
    ...
    for image_file in glob(os.path.join(data_folder, 'image_2', '*.png')):
        ...
        im_softmax = sess.run([tf.nn.softmax(logits)],{keep_prob: 1.0, image_pl: [image]})#########funciona
        #print("softmax ",len(im_softmax))
        im_softmax = im_softmax[0][:, 1].reshape(image_shape[1], image_shape[0])#########funciona
        ...
        #print("segmantation ",segmentation.shape)#########funciona
        ...
        yield os.path.basename(image_file), np.array(street_im)#########funciona
