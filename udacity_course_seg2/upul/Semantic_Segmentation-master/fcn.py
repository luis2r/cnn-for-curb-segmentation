...
if __name__ == '__main__':
    ...
    runs_dir = './runs'
    viz_dir = '/home/shared/datasets/data_road/testing'
    input_size = (160, 576)
    num_train_examples = 289

    get_batches_fn = helper.gen_batch_function(os.path.join(data_dir, '/home/shared/datasets/data_road/training'), input_size)
